...
<html lang="en">
    ...
    <head>
        ...
        <title>Pages / Register - Doctors A2Z Software</title>
                            ...
                            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="d-flex justify-content-center py-4">
                                    <a href="index.html" class="logo d-flex align-items-center w-auto">
                                        <img src="admin/assets/img/doctor-logo.png" alt="">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('register') }}"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input class="form-control" type="text" id="name" type="text"
                      ...
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="password" name="password" class="form-control"
                                                    id="yourPassword" placeholder="Please provide 9 digit password"
                                                    required>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="password" id="password_confirmation" type="password"
                                                    ...
                                                    placeholder="Please provide 9 digit password" required
