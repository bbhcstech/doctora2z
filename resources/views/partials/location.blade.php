  ...
  <div class="row g-3">
    ...
    <div class="col-md-4">
      ...
      <div class="d-flex gap-2">
        <input name="pincode" id="pincode_partial" class="form-control" value="{{ old('pincode', optional($d->pincode)->pincode ?? '') }}" maxlength="6">
        <button type="button" id="pincodeLookupBtn_partial" class="btn btn-outline-primary">Lookup</button>
      </div>
      <input type="hidden" name="pincode_id" id="pincode_id_partial" value="{{ old('pincode_id', $d->pincode_id ?? '') }}">
