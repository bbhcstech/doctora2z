...
<form action="{{ route('doctor.profile.updatePersonal', $d->id ?? '') }}" method="POST" enctype="multipart/form-data"
    id="personalFormPartial">
    @csrf
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input name="phone_number" class="form-control" value="{{ old('phone_number', $d->phone_number ?? '') }}"
                required>
        </div>

        <div class="col-md-6">
            <label class="form-label">Phone Number 2</label>
            <input name="phone_number_2" class="form-control"
