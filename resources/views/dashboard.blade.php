...
<div class="container mt-4">
    <div class="row">
        ...
        <!--            <p class="card-text">Total Clinics: <strong>@if($totalClinics > 0){{ $totalClinics }}@else  No clinics found @endif</strong></p>-->
        ...
        <div class="col-md-6">
            <div class="card shadow d-flex flex-row align-items-center" style="border-left: 5px solid #28a745;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Total Doctors: <strong>@if($totalDoctors > 0){{ $totalDoctors }}@else{-- No doctor found --}@endif</strong></p>
                    <p class="card-text text-success">Approved Doctors: <strong>{{ $approvedDoctorCount }}</strong></p>
                    <p class="card-text text-warning">Pending Doctors: <strong>{{ $pendingDoctorCount}}</strong></p>
                </div>
            </div>
        </div>
    </div>
