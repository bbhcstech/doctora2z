...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">   
    ...
    <li class="nav-item">
      ...
      <ul id="doctorProfile-nav" class="nav-content collapse 
          ...
          || request()->routeIs('doctor.profile.educationSchedule') ? 'show' : '' }}" 
    ...
    @if(Auth::check() && Auth::user()->role === 'admin')
      <!-- Admin Panel Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#manageDoctor-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i>
          <span>Manage Doctor</span>
          <i class="bi bi-chevron-down ms-auto"></i>
        </a>
     
        <ul id="manageDoctor-nav" class="nav-content collapse {{ request()->routeIs('doctors*') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
          <li>
          ...
          <li>
            <a href="{{ route('doctors.create') }}" class="{{ request()->routeIs('doctors.create') ? 'active' : '' }}">
