  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('doctors.index') }}">Hospitals Listing</a></li>
    ...
    <div class="card-body">
     <form action="{{ route('hospital.store') }}" method="POST" enctype="multipart/form-data">
       @csrf
        ...
        <div class="col-md-10 mb-3">
            <label for="name" class="form-label">Hospital Address Link</label>
        ...
        <!-- Image Upload -->
        <div class="col-md-10 mb-3">
            <label for="image" class="form-label">Upload Hospital's Image</label>
