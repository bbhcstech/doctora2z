        ...
        <div class="row g-2">
            ...
            <div class="col-md-4">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="phone_number2" name="phone_number2" value="{{ old('phone_number2') }}">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="website" name="website" value="{{ old('website') }}" pattern="https?://.*" placeholder="https://example.com">
                     @error('website')
            ...
            <div class="col-md-4">
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" id="logitude" name="logitude" value="{{ old('logitude') }}">
                    @error('logitude')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    firstFileInput.addEventListener("change", function () {
        ...
        firstRemoveButton.style.display = "inline-block"; // Show the Remove button after selecting a file
    });
