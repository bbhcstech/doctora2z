                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @forelse($images as $image)
                                ...
                                @endphp
                                <img src="{{ $src }}" alt="Clinic Image" style="max-width:100px;max-height:100px;margin-right:10px">
                            @empty
                                N/A
                            @endforelse
                        </td>
                        ...
                        <td>
                            @php
                                ...
                                $categoryNames = $ids ? \App\Models\Category::whereIn('id', $ids)->pluck('name')->toArray() : [];
                            @endphp
                        ...
                        <td>
                            <div class="d-inline-flex gap-2">
                                <a href="{{ route('clients.edit', $clinic->id) }}" class="btn btn-warning btn-sm">Edit</a>
                                <a href="{{ route('clients.show', $clinic->id) }}" class="btn btn-success btn-sm">Show</a>

                                <form action="{{ route('clients.destroy', $clinic->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
