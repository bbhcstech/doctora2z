    ...
    <div class="card-body">
      ...
      <form action="{{ route('contact-us.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="mail" name="mail" value="{{ $contactUs->mail }}" >
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="map_url" name="map_url" value="{{ $contactUs->map_url }}" >
        </div>
        ...
        <div class="mb-3">
          ...
          @if (!empty($contactUs->banner_image))
            <div class="mb-2">
              <img src="{{ asset('admin/uploads/contact/' . $contactUs->banner_image) }}" alt="Banner Image" style="max-width: 150px; height: auto;">
            </div>
          @endif
