...
@section('title', 'Add New Medicashop')
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('doctors.index') }}">Medica Shop Listing</a></li>
        <li class="breadcrumb-item active">Add New Medica Shop</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  @if ($errors->any())
...
@endif
  ...
  <div class="card" style="background-color: #d8e0f1; border-radius: 10px;">
    <div class="card-body">
     <form action="{{ route('medicashop.store') }}" method="POST" enctype="multipart/form-data">
       @csrf
         <!-- Submit Button -->
        ...
        <div class="col-md-10 mb-3">
            <label for="name" class="form-label">Medica Shop Address Link</label>
        ...
        <!-- Image Upload -->
        <div class="col-md-10 mb-3">
            <label for="image" class="form-label">Upload Medica Shop's Image</label>
