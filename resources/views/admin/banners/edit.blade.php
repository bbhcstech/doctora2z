      ...
      <form action="{{ route('banner.update', $banner->id) }}" method="POST"  enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            @if (!empty($banner->image))
                <div class="mb-2">
                    <img src="{{ asset('admin/uploads/banners/' . $banner->image) }}" alt="Banner Image" style="max-width: 150px; height: auto;">
                </div>
            @endif
        ...
        <div class="mb-3">
            ...
            @if (!empty($banner->mobile_image))
                <div class="mb-2">
                    <img src="{{ asset('admin/uploads/banners/' . $banner->mobile_image) }}" alt="Banner Mobile Image" style="max-width: 150px; height: auto;">
                </div>
            @endif
        
            <!-- Input for uploading a new image -->
            <input type="file" class="form-control" id="mobile_image" name="mobile_image" placeholder="Enter banner mobile image">
        </div>
        </div>
  </div>
<div class="text-end">
