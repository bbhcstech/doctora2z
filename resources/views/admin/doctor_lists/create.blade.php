                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                    ...
                                    @error('category_id')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <button type="button" id="addCategoryTag" class="btn btn-primary mt-2">Category Add
                                        to Tags</button>
                                </div>
                                    ...
                                    <div class="time-field-pair">
                                        <div class="row">
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="time_slot[0][start]"
                                                    class="form-control start-time"
                                                    value="{{ old('time_slot.0.start') }}" required>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input type="text" name="time_slot[0][end]"
                                                    class="form-control end-time" value="{{ old('time_slot.0.end') }}"
                                                    required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('fees') is-invalid @enderror"
                                    id="fees" name="fees" value="{{ old('fees') }}" inputmode="numeric"
                                    pattern="\d*">
                                @error('fees')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
