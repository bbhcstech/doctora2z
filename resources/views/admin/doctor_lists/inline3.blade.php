  ...
  <div class="container-fluid mt-3">
   ...
   {{-- TABS --}}
    <ul class="nav nav-tabs" id="doctorTabs" role="tablist">
      ...
      <li class="nav-item" role="presentation">
        <button class="nav-link" id="form-tab" data-bs-toggle="tab" data-bs-target="#formPane" type="button" role="tab">
          ...
          <div class="card-body p-2">
            <div class="table-responsive" style="max-height:520px; overflow:auto;">
              <table id="doctorsTable" class="table table-modern align-middle w-100 table-striped">
                <thead>
                  <tr>
                    <th style="width:44px"><input type="checkbox" id="selectAll" aria-label="Select all"></th>
      ...
      <div class="tab-pane fade" id="formPane" role="tabpanel" aria-labelledby="form-tab">
        ...
        <div class="card card-lite mb-4">
          <div class="card-body py-3 px-3 px-md-4">
            <form id="doctorCreateForm" class="row g-3" action="{{ route('doctor_inline.store') }}" method="POST" enctype="multipart/form-data" novalidate>
              @csrf

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_name">Name <span class="text-danger">*</span></label>
                <input id="cf_name" type="text" name="name" class="form-control form-control-compact" required>
                <div class="invalid-feedback">Please enter doctor's name</div>
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_email">Email <span class="text-danger">*</span></label>
                <input id="cf_email" type="email" name="email" class="form-control form-control-compact" required>
                <div class="invalid-feedback">Please enter a valid email</div>
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_phone">Phone <span class="text-danger">*</span></label>
                <input id="cf_phone" type="text" name="phone_number" class="form-control form-control-compact" required>
                <div class="invalid-feedback">Please enter phone number</div>
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_phone2">Alternate Phone</label>
                <input id="cf_phone2" type="text" name="phone_number_2" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_speciality">Speciality <span class="text-danger">*</span></label>
                <input id="cf_speciality" type="text" name="speciality" class="form-control form-control-compact" required>
              ...
              <div class="col-12 col-md-4">
                ...
                <input id="cf_degree" type="text" name="degree" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_regno">Registration No.</label>
                <input id="cf_regno" type="text" name="registration_no" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_council">Council</label>
                <input id="cf_council" type="text" name="council" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_pincode">Pincode</label>
                <input id="cf_pincode" type="text" name="pincode" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_website">Website</label>
                <input id="cf_website" type="url" name="website" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_whatsapp">Whatsapp</label>
                <input id="cf_whatsapp" type="text" name="whatsapp" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_facebook">Facebook</label>
                <input id="cf_facebook" type="text" name="facebook" class="form-control form-control-compact">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_instagram">Instagram</label>
                <input id="cf_instagram" type="text" name="instagram" class="form-control form-control-compact">
              </div>

              {{-- New Fields --}}
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_experience">Experience (Years)</label>
                <input id="cf_experience" type="number" name="experience_years" class="form-control form-control-compact" min="0" max="100">
              </div>

              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_languages">Languages</label>
                <input id="cf_languages" type="text" name="languages" class="form-control form-control-compact" placeholder="English, Hindi, Bengali">
              </div>
              ...
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_country">Country <span class="text-danger">*</span></label>
                <select name="country_id" id="cf_country" class="form-select form-select-compact" required>
              ...
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_state">State <span class="text-danger">*</span></label>
                <select name="state_id" id="cf_state" class="form-select form-select-compact" required>
              ...
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_city">City <span class="text-danger">*</span></label>
                <select name="city_id" id="cf_city" class="form-select form-select-compact" required>
                  <option value="">Select City</option>
                  @foreach($cities as $ci)
                    <option value="{{ $ci->id }}" data-district="{{ $ci->district_id }}">{{ $ci->name }}</option>
                  @endforeach
                </select>
              ...
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_category">Category <span class="text-danger">*</span></label>
                <select name="category_id" id="cf_category" class="form-select form-select-compact" required>
              ...
              <div class="col-12 col-md-4">
                ...
                <input id="cf_photo" type="file" name="photo" accept="image/*" class="form-control form-control-compact">
              ...
              <div class="col-12">
                ...
                <button type="button" id="addScheduleBtn" class="btn btn-outline-secondary btn-compact mb-2">
                  <i class="bi bi-plus-lg me-1"></i> Add Clinic / Schedule
                </button>
                <input type="hidden" name="schedules_json" id="schedules_json" value="[]">
                <small class="text-muted d-block mt-2">Pick clinic(s) inside the schedule rows. The first schedule's clinic will be used as the doctor's primary clinic automatically.</small>
              </div>
              ...
              <template id="scheduleRowTpl">
                <div class="schedule-row card p-2 mb-2" data-tempid="">
                  <div class="row g-2 align-items-center">
                    <div class="col-md-4">
                      <label class="form-label form-label-xs mb-1">Clinic (select or enter)</label>
                      <div class="d-flex gap-2">
                        <select class="form-select form-select-compact flex-grow-1 clinic_select">
                          <option value="">Select Clinic</option>
                          @foreach($clinics as $cl)
                            <option value="{{ $cl->id }}" data-category="{{ $cl->category_id }}">{{ $cl->name }}</option>
                          @endforeach
                        </select>
                        <input type="text" class="form-control form-control-compact clinic_text" placeholder="Or type clinic name">
                      </div>
                    </div>

                    <div class="col-md-3">
                      <label class="form-label form-label-xs mb-1">Days</label>
                      <select class="form-select form-select-compact days_select" multiple style="height: 80px;">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="time" class="form-control form-control-compact start_time">
                    </div>
                    ...
                    <div class="col-md-11 mt-2">
                      ...
                      <input type="text" class="form-control form-control-compact alt_text" placeholder="e.g. by appointment only">
                    </div>

                    <div class="col-md-1 d-flex align-items-start mt-2">
                      <button type="button" class="btn btn-outline-danger btn-square removeScheduleBtn" title="Remove">
              ...
              <div class="col-12 col-md-4">
                <label class="form-label form-label-xs mb-1" for="cf_consultation">Consultation Mode <span class="text-danger">*</span></label>
                <select id="cf_consultation" name="consultation_mode" class="form-select form-select-compact" required>
              ...
              <div class="col-12 d-flex flex-column flex-md-row gap-2 justify-content-between mt-4">
                <div class="btn-group">
                  <a href="{{ route('doctor_inline.export.sample') }}" class="btn btn-outline-secondary btn-compact" data-bs-toggle="tooltip" title="Download Sample CSV">
                    <i class="bi bi-filetype-csv me-1"></i> Sample
                  </a>
                  <label class="btn btn-outline-secondary btn-compact mb-0" data-bs-toggle="tooltip" title="Import CSV/XLSX">
                    <i class="bi bi-upload me-1"></i> Import
                    <input id="import_file" type="file" class="d-none" accept=".csv,.xls,.xlsx,.txt">
                  </label>
                </div>
                <div class="btn-group">
                  <a href="{{ route('doctor_inline.export.csv') }}" class="btn btn-outline-secondary btn-compact" data-bs-toggle="tooltip" title="Export CSV"><i class="bi bi-filetype-csv me-1"></i> CSV</a>
                  <a href="{{ route('doctor_inline.export.excel') }}" class="btn btn-outline-secondary btn-compact" data-bs-toggle="tooltip" title="Export Excel"><i class="bi bi-filetype-xlsx me-1"></i> Excel</a>
                  <a href="{{ route('doctor_inline.export.pdf') }}" class="btn btn-outline-secondary btn-compact" data-bs-toggle="tooltip" title="Export PDF"><i class="bi bi-filetype-pdf me-1"></i> PDF</a>
                </div>
              </div>
            </form>
          </div>
...
<style>
  ...
  .table-modern thead tr{ background:#f1f3f5; color:#333; font-weight:700; position:sticky; top:0; z-index:5 }
  .table-modern th, .table-modern td{ padding:.6rem .6rem; vertical-align:middle; }

  .form-control-compact, .form-select-compact{ height:36px; padding:.25rem .5rem; border:1px solid #ddd !important; border-radius:8px; font-size:.9rem; box-shadow:none; }
  ...
  .btn-brand:hover{ background:#138a3f; border-color:#138a3f; }

  .btn-square{ width:32px; height:32px; display:inline-flex; align-items:center; justify-content:center; padding:0; border-radius:6px; }
  ...
  .btn-spinner{ width:1rem; height:1rem; border:.15em solid currentColor; border-right-color:transparent; border-radius:50%; display:inline-block; animation:spin .75s linear infinite; vertical-align: -2px; }
  @keyframes spin{ to { transform: rotate(360deg); } }

  .text-danger{ color:#dc3545; }
  .form-text{ font-size:.75rem; color:#6c757d; }

  /* small responsive tweaks */
  @media (max-width:900px){ .table-modern thead{ font-size:.8rem } }
</style>
...
(function(){
  ...
  function showToast(message, {type='success', title='', delay=4000} = {}) {
    const id = 't' + Date.now() + Math.random().toString(16).slice(2);
    const header = title ? `<div class="toast-header border-0"><strong class="me-auto">${htmlEsc(title)}</strong><button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button></div>` : '';
    const bodyClass = title ? '' : (type==='success'?'bg-success text-white':type==='danger'?'bg-danger text-white':'bg-info text-dark');
    const html = `<div id="${id}" class="toast shadow-sm mb-2 overflow-hidden" data-bs-delay="${delay}" role="status" aria-live="polite">${header}<div class="toast-body ${bodyClass}">${htmlEsc(message)}</div></div>`;
    const stack = document.getElementById('toastStack'); stack.insertAdjacentHTML('beforeend', html);
    new bootstrap.Toast(document.getElementById(id)).show();
  }
  
  const notify = { 
    ok: (m,t='Success')=>showToast(m,{type:'success',title:t}), 
    err:(m,t='Error')=>showToast(m,{type:'danger',title:t}), 
    info:(m,t='Info')=>showToast(m,{type:'info',title:t}) 
  };
  ...
  function buildOptions(list, selectedId, {placeholder='Select'}={}, filter=()=>true){
  ...
  $('#cf_country').on('change', function(){
    const id = $(this).val();
    $('#cf_state').html(buildOptions(STATES, null, {placeholder:'Select State'}, s=>s.country_id==id)).val('');
  ...
  $('#cf_state').on('change', function(){
    const id = $(this).val();
    $('#cf_district').html(buildOptions(DISTRICTS, null, {placeholder:'Select District'}, d=>d.state_id==id)).val('');
    $('#cf_city').html('<option value="">Select City</option>').val('');
  });
  
  $('#cf_district').on('change', function(){
    const id = $(this).val();
    $('#cf_city').html(buildOptions(CITIES, null, {placeholder:'Select City'}, c=>c.district_id==id)).val('');
  });
  ...
  function readScheduleRow($row) {
    ...
    const empty = !clinic_id && !clinic_name && (!days || days.length === 0) && !start_time_raw && !end_time_raw && !alternative_text;
  ...
  $('#doctorCreateForm').on('submit', function(e){
    ...
    if ((!topClinicId || topClinicId === '') && schedules.length > 0) {
      ...
      if (first.clinic_id) {
        ...
        let found = CLINICS.find(c => String(c.name).toLowerCase() === String(first.clinic_name).toLowerCase());
        if (!found) found = CLINICS.find(c => String(c.name).toLowerCase().includes(String(first.clinic_name).toLowerCase()));
        if (found) {
    ...
    .fail(xhr=>{
      ...
      if (xhr.responseJSON) {
        if (xhr.status === 422 && xhr.responseJSON.errors) {
          ...
          const flat = [];
          Object.keys(errs).forEach(k => { (errs[k]||[]).forEach(m => flat.push(m)); });
          msg = flat.slice(0,5).join('; ');
          notify.err(msg);
          console.groupCollapsed('Validation errors'); console.table(errs); console.groupEnd();
        } else if (xhr.responseJSON.message) {
          msg = xhr.responseJSON.message + (xhr.responseJSON.error ? (': '+xhr.responseJSON.error) : '');
          notify.err(msg);
        } else {
  ...
  let table = $('#doctorsTable').DataTable({
    ...
    columns: [
      ...
      // Basic fields
      { data:'name', name:'name', render:(d)=> `<input class="form-control form-control-sm editable" data-field="name" value="${htmlEsc(d??'')}">` },
      { data:'email', name:'email', render:(d)=> `<input class="form-control form-control-sm editable" data-field="email" value="${htmlEsc(d??'')}">` },
      { data:'phone_number', name:'phone_number', render:(d)=> `<input class="form-control form-control-sm editable" data-field="phone_number" value="${htmlEsc(d??'')}">` },
      { data:'phone_number_2', name:'phone_number_2', render:(d)=> `<input class="form-control form-control-sm editable" data-field="phone_number_2" value="${htmlEsc(d??'')}">` },
      { data:'speciality', name:'speciality', render:(d)=> `<input class="form-control form-control-sm editable" data-field="speciality" value="${htmlEsc(d??'')}">` },

      // extra form fields visible in table
      { data:'registration_no', name:'registration_no', render:(d)=> `<input class="form-control form-control-sm editable" data-field="registration_no" value="${htmlEsc(d??'')}">` },
      { data:'council', name:'council', render:(d)=> `<input class="form-control form-control-sm editable" data-field="council" value="${htmlEsc(d??'')}">` },
      { data:'pincode', name:'pincode', render:(d,_,r)=> {
          const pincodeValue = (r.manual_pincode ?? '') || (r.pincode ? (r.pincode.pincode ?? '') : '');
          return `<input class="form-control form-control-sm editable" data-field="pincode" value="${htmlEsc(pincodeValue)}">`;
        }
      },
      { data:'website', name:'website', render:(d)=> `<input class="form-control form-control-sm editable" data-field="website" value="${htmlEsc(d??'')}">` },
      { data:'whatsapp', name:'whatsapp', render:(d)=> `<input class="form-control form-control-sm editable" data-field="whatsapp" value="${htmlEsc(d??'')}">` },
      { data:'facebook', name:'facebook', render:(d)=> `<input class="form-control form-control-sm editable" data-field="facebook" value="${htmlEsc(d??'')}">` },
      { data:'instagram', name:'instagram', render:(d)=> `<input class="form-control form-control-sm editable" data-field="instagram" value="${htmlEsc(d??'')}">` },
      { data:'address', name:'address', render:(d)=> `<input class="form-control form-control-sm editable" data-field="address" value="${htmlEsc(d??'')}">` },

      // Location & relationships
      { data:'country_id', name:'country_id', render:(d,__,r)=> `<select class="form-select form-select-sm editable countrySel" data-field="country_id">${buildOptions(COUNTRIES, d, {placeholder:'Country'})}</select>` },
      { data:'state_id', name:'state_id', render:(d,__,r)=> `<select class="form-select form-select-sm editable stateSel" data-field="state_id">${buildOptions(STATES, d, {placeholder:'State'}, s=>String(s.country_id)===String(r.country_id))}</select>` },
      { data:'district_id', name:'district_id', render:(d,__,r)=> `<select class="form-select form-select-sm editable districtSel" data-field="district_id">${buildOptions(DISTRICTS, d, {placeholder:'District'}, x=>String(x.state_id)===String(r.state_id))}</select>` },
      { data:'city_id', name:'city_id', render:(d,__,r)=> `<select class="form-select form-select-sm editable citySel" data-field="city_id">${buildOptions(CITIES, d, {placeholder:'City'}, x=>String(x.district_id)===String(r.district_id))}</select>` },

      // Category
      { data:'category_id', name:'category_id', render:(d,__,r)=> {
      ...
      // Clinic
      { data:'clinic_id', name:'clinic_id', render:(d,__,r)=> {
          const sel = (r && r.clinic && r.clinic.id) ? r.clinic.id : d;
          const cat = (r && r.category && r.category.id) ? r.category.id : (r && r.category_id ? r.category_id : null);
      ...
      { data:'consultation_mode', name:'consultation_mode', render:(d)=> { 
  ...
  $('#doctorsTable').on('change','.countrySel', function(){ 
    ...
    editedRow($tr); 
    const cid = $(this).val(); 
    $tr.find('.stateSel').html(buildOptions(STATES, null, {placeholder:'State'}, s=>String(s.country_id)===String(cid))).val(''); 
  ...
  $('#doctorsTable').on('change','.stateSel', function(){ 
    ...
    editedRow($tr); 
    const sid = $(this).val(); 
    $tr.find('.districtSel').html(buildOptions(DISTRICTS, null, {placeholder:'District'}, d=>String(d.state_id)===String(sid))).val(''); 
    $tr.find('.citySel').html('<option value="">City</option>').val(''); 
  });
  ...
  $('#doctorsTable').on('change','.districtSel', function(){ 
    ...
    editedRow($tr); 
    const did = $(this).val(); 
    $tr.find('.citySel').html(buildOptions(CITIES, null, {placeholder:'City'}, c=>String(c.district_id)===String(did))).val(''); 
  });
  ...
  $('#doctorsTable').on('change','.catSel', function(){ 
    ...
    const html = buildOptions(CLINICS, keep, {placeholder:'Clinic'}, c=>!cat || String(c.category_id)===String(cat)); 
  ...
  $('#doctorsTable').on('click','.deleteRow', function(){
    const id = $(this).data('id');
    confirmAction('Are you sure you want to delete this doctor?', {okText:'Delete'}).then(ok=>{
      if(!ok) return;
      $.ajax({ 
  ...
  $('#bulkDeleteBtn').on('click', function(){
    ...
    confirmAction(`Are you sure you want to delete ${ids.length} selected doctor(s)?`, {okText:'Delete'}).then(ok=>{
      if(!ok) return;
      $.ajax({ 
