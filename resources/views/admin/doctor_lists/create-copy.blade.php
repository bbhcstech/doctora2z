  ...
  <div class="card">
    <div class="card-body">
      <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
       ...
       <div class="mb-3">
        <div class="mb-3">
    <label for="clinic_ids" class="form-label">Clinics <span style="color: red;">*</span></label>
            ...
            <div class="time-field-pair">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="start_time[]" class="form-control start-time" value="{{ old('start_time.0') }}" required>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="end_time">End Time:</label>
                        <input type="text" name="end_time[]" class="form-control end-time" value="{{ old('end_time.0') }}" required>
                    </div>
                    <div class="col-md-4 mb-3">
