            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="doctorForm" method="POST" action="{{ route('admin.doctors.store') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="experience_years"
                                            name="experience_years" min="0" max="100">
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#category_id').on('change', function() {
                ...
                if (categoryId) {
                    ...
                    $.get('/admin/doctors/clinics/' + categoryId, function(data) {
                        ...
                        $.each(data, function(key, value) {
                            $('#clinic_id').append('<option value="' + value.id + '">' +
                                value.name + '</option>');
                        });
                    });
                }
            ...
            function addSchedule() {
                ...
                newSchedule.find('.clinic-select').select2({
                    width: '100%'
                });
