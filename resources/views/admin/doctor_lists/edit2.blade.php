        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="doctorForm" method="POST" action="{{ route('admin.doctors.update', $doctor->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="text-center">
                                    <img src="{{ Storage::url($doctor->profile_picture) }}" alt="Profile Picture" class="img-thumbnail" style="max-width: 200px;">
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="consultation_mode" name="consultation_mode" required>
                                        <option value="face-to-face" {{ $doctor->consultation_mode == 'face-to-face' ? 'selected' : '' }}>Face to Face</option>
                                        <option value="online" {{ $doctor->consultation_mode == 'online' ? 'selected' : '' }}>Online</option>
                                        <option value="both" {{ $doctor->consultation_mode == 'both' ? 'selected' : '' }}>Both</option>
                                        <option value="offline" {{ $doctor->consultation_mode == 'offline' ? 'selected' : '' }}>Offline</option>
                                    </select>
                                </div>
                            </div>
