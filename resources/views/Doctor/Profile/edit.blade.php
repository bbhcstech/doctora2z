...
@section('content')
    ...
    <main id="main" class="main">
        ...
        <div class="container-fluid">
                ...
                if (empty($clinicsData)) {
                    ...
                    if (!empty($rawClinicsAttr)) {
                        if (is_string($rawClinicsAttr)) {
                            ...
                            is_array($rawClinicsAttr) ||
                            $rawClinicsAttr instanceof \Illuminate\Support\Collection
                        ) {
                ...
                if (empty($clinicsData)) {
                    $clinicsData = [
                        [
                            ...
                            'clinic_name' => '',
                            'clinic_address' => '',
                            'schedules' => [['day' => 'monday', 'start' => '', 'end' => '']],
                        ],
                    ];
                } else {
                    $clinicsData = array_values(
                        ...
                        <div class="card-body text-center py-4">
                            <div class="profile-avatar-wrapper position-relative mx-auto" style="max-width: 220px;">
                                <div class="avatar-container position-relative">
                                    ...
                                    <div class="avatar-overlay">
                                        <label for="profile_picture"
                                            class="btn btn-primary rounded-circle avatar-upload-btn">
                                    ...
                                    <div class="d-flex flex-wrap justify-content-center gap-2">
                                        ...
                                        @if (!empty($d) && !empty($d->profile_picture))
                                            <form id="removePhotoForm"
                                                action="{{ route('doctor.profile.remove-photo', $d->id ?? '') }}"
                                ...
                                <div class="text-muted small mt-3">
                                    ...
                                    Last updated:
                                    {{ $d && !empty($d->updated_at) ? $d->updated_at->format('M d, Y') : '—' }}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('doctor.profile.update', $d->id ?? '') }}" method="POST"
                        enctype="multipart/form-data" id="doctorProfileForm" novalidate>
                        @csrf
                        ...
                        <input type="hidden" id="top_clinic_id" name="clinic_id"
                            value="{{ old('clinic_id', $d->clinic_id ?? '') }}">
                        <input type="hidden" id="top_clinic_name" name="clinic_name"
                            value="{{ old('clinic_name', $d->clinic_name ?? '') }}">
                        <input type="hidden" id="top_clinic_start_time" name="clinic_start_time"
                            value="{{ old('clinic_start_time', $d->clinic_start_time ?? '') }}">
                        <input type="hidden" id="top_clinic_end_time" name="clinic_end_time"
                            value="{{ old('clinic_end_time', $d->clinic_end_time ?? '') }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="phone_number" class="form-control"
                                                value="{{ old('phone_number', $d->phone_number ?? '') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="phone_number_2" class="form-control"
                                                value="{{ old('phone_number_2', $d->phone_number_2 ?? '') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="whatsapp" class="form-control"
                                                value="{{ old('whatsapp', $d->whatsapp ?? '') }}">
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Profile Status <span
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="degree" class="form-control"
                                                value="{{ old('degree', $d->degree ?? '') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="speciality" class="form-control"
                                                value="{{ old('speciality', $d->speciality ?? '') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="registration_no" class="form-control"
                                                value="{{ old('registration_no', $d->registration_no ?? '') }}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="category_id" id="category_id" class="form-select" required>
                                                ...
                                                @foreach ($categories ?? [] as $id => $name)
                                                    <option value="{{ $id }}" @selected((string) old('category_id', $d->category_id ?? '') === (string) $id)>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label">Consultation Mode <span
                                                class="text-danger">*</span></label>
                                        <div class="input-group">
                                            ...
                                            <select name="consultation_mode" class="form-select" required>
                                                ...
                                                <option value="face-to-face" @selected(old('consultation_mode', $d->consultation_mode ?? '') === 'face-to-face')>Face-to-face
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="country_id" id="country_id" class="form-select" required>
                                                ...
                                                @foreach ($countries ?? [] as $id => $name)
                                                    <option value="{{ $id }}" @selected((string) old('country_id', $d->country_id ?? '') === (string) $id)>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="state_id" id="state_id" class="form-select" required>
                                                ...
                                                @foreach ($states ?? [] as $id => $name)
                                                    <option value="{{ $id }}" @selected((string) old('state_id', $d->state_id ?? '') === (string) $id)>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="district_id" id="district_id" class="form-select" required>
                                                ...
                                                @foreach ($districts ?? [] as $id => $name)
                                                    <option value="{{ $id }}" @selected((string) old('district_id', $d->district_id ?? '') === (string) $id)>
                                                        {{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        {{-- Cant find area --}}
                                        <small class="text-primary d-block mt-1" id="cantFindArea"
                                            style="cursor:pointer">
                                            Cant find your area?
                                        </small>

                                        {{-- Manual city input --}}
                                        <input type="text" name="other_city_name" id="other_city_name"
                                            class="form-control mt-2 d-none" placeholder="Enter your area name">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <small id="pincodeHelp" class="text-muted">Enter 6-digit pincode and click
                                            lookup</small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <p class="text-muted mb-4">Add clinics where the doctor practices along with their
                                    schedules.</p>
                                        ...
                                        <div class="clinic-block card border mb-3" data-index="{{ $idx }}">
                                            <div class="card-header bg-light">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-sm btn-outline-danger removeClinicBtn">
                                                        <i class="bi bi-trash me-1"></i>Remove
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row g-3 mb-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label">Select Clinic <span
                                                                class="text-danger">*</span></label>
                                                        <select name="clinics[{{ $idx }}][clinic_id]"
                                                            class="form-select clinic-select">
                                                            <option value="">Enter clinic name if not found</option>
                                                            @foreach ($clinics ?? [] as $id => $name)
                                                                <option value="{{ $id }}"
                                                                    @selected((string) ($clinic['clinic_id'] ?? '') === (string) $id)>{{ $name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-outline-success btn-sm addScheduleBtn">
                                                    ...
                                                    <div class="schedule-rows">
                                                        @foreach ($schedules as $sIdx => $sch)
                                                            <div class="row g-2 align-items-end schedule-row mb-2">
                                                                <div class="col-md-3">
                                                                    <label class="form-label">Day <span
                                                                            class="text-danger">*</span></label>
                                                                    <select
                                                                        name="clinics[{{ $idx }}][schedules][{{ $sIdx }}][day]"
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label class="form-label">Start Time <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="time"
                                                                        name="clinics[{{ $idx }}][schedules][{{ $sIdx }}][start]"
                                                                        class="form-control"
                                                                        value="{{ $sch['start'] ?? '' }}" required>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <label class="form-label">End Time <span
                                                                            class="text-danger">*</span></label>
                                                                    <input type="time"
                                                                        name="clinics[{{ $idx }}][schedules][{{ $sIdx }}][end]"
                                                                        class="form-control"
                                                                        value="{{ $sch['end'] ?? '' }}" required>
                                                                </div>

                                                                <div class="col-md-3">
                                                                    <label
                                                                        class="form-label d-none d-md-block">&nbsp;</label>
                                                                    <button type="button"
                                                                        class="btn btn-outline-danger btn-sm w-100 removeScheduleBtn"
                                                                        @if ($sIdx === 0) disabled @endif>
    ...
    `;
            ...
            function reindexClinics() {
                ...
                clinicBlocks.forEach((block, blockIndex) => {
                    ...
                    scheduleRows.forEach((row, rowIndex) => {
                        ...
                        if (timeInputs[0]) {
                            timeInputs[0].name =
                            `clinics[${blockIndex}][schedules][${rowIndex}][start]`;
                        }
                        if (timeInputs[1]) {
                    ...
                    clinicBlocks.forEach((block, blockIndex) => {
                        ...
                        scheduleRows.forEach((row, rowIndex) => {
                            ...
                            if (!dayValue) {
                                isValid = false;
                                errorMessage =
                                    `Clinic ${blockIndex + 1}, schedule ${rowIndex + 1}: Please select a day.`;
                                return;
                            }
                            ...
                            if (!startValue) {
                                isValid = false;
                                errorMessage =
                                    `Clinic ${blockIndex + 1}, schedule ${rowIndex + 1}: Please set start time.`;
                                return;
                            }
                            ...
                            if (!endValue) {
                                isValid = false;
                                errorMessage =
                                    `Clinic ${blockIndex + 1}, schedule ${rowIndex + 1}: Please set end time.`;
                                return;
                            }
                            ...
                            if (startValue && endValue) {
                                if (startValue >= endValue) {
                                    isValid = false;
                                    errorMessage =
                                        `Clinic ${blockIndex + 1}, schedule ${rowIndex + 1}: End time must be after start time.`;
                                    return;
                                }
                            }
                        });
            ...
            async function loadStates(countryId, preselect = '') {
                ...
                const data = await fetchJson(
                    `{{ rtrim(url('/doctor/profile'), '/') }}/get-states/${encodeURIComponent(countryId)}`);
            ...
            async function loadDistricts(stateId, preselect = '') {
                ...
                const data = await fetchJson(
                    `{{ rtrim(url('/doctor/profile'), '/') }}/get-districts/${encodeURIComponent(stateId)}`);
            ...
            async function loadCities(districtId, preselect = '') {
                ...
                const data = await fetchJson(
                    `{{ rtrim(url('/doctor/profile'), '/') }}/get-cities/${encodeURIComponent(districtId)}`);
            ...
            async function loadClinicsByCategory(categoryId) {
                ...
                try {
                    const res = await fetch(
                        `{{ rtrim(url('/doctor/profile'), '/') }}/clinics-by-category/${encodeURIComponent(categoryId)}`, {
                            credentials: 'same-origin',
                            headers: {
                                'X-Requested-With': 'XMLHttpRequest',
                                'X-CSRF-TOKEN': getCsrf()
            ...
            if (pincodeBtn && pincodeInput) {
                pincodeBtn.addEventListener('click', async function(e) {
                    ...
                    try {
                        const url =
                            `{{ rtrim(url('/doctor/profile'), '/') }}/pincode/${encodeURIComponent(pincode)}/lookup`;
                        ...
                        if (pincodeHelp) {
                            pincodeHelp.textContent =
                                `Found: ${payload.city || payload.office_name || payload.pincode}`;
