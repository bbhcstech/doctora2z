      ...
      <div class="col-lg-6 col-md-8 col-sm-10">
        ...
        <div class="card border-0 shadow-lg rounded-4">
          <div class="card-body p-4">
            ...
            <form id="changePasswordForm" method="POST" action="{{ route('doctor.profile.password.update') }}" novalidate>
              @csrf
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  ...
                  <button class="btn btn-outline-secondary" type="button" id="toggleCurrentPwd">Show</button>
                </div>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="password" id="new_password" name="new_password"
                         ...
                         required autocomplete="new-password" placeholder="Create a new password">
                  <button class="btn btn-outline-secondary" type="button" id="toggleNewPwd">Show</button>
                </div>
                @error('new_password')
                  <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
              ...
              <div class="mb-4">
                ...
                <div class="input-group">
                  ...
                  <button class="btn btn-outline-secondary" type="button" id="toggleConfirmPwd">Show</button>
                </div>
...
(function () {
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (!currentPwd.value.trim() || !newPwd.value.trim() || !confirmPwd.value.trim()) {
      ...
      window.scrollTo({ top: formAlert.offsetTop - 80, behavior: 'smooth' });
      return;
    }
    ...
    if (!canSubmit()) {
      e.preventDefault();
      formAlert.classList.remove('d-none');
      formAlert.textContent = 'Please meet all password requirements and ensure both fields match.';
      window.scrollTo({ top: formAlert.offsetTop - 80, behavior: 'smooth' });
      return;
    }
