...
<footer id="site-footer" class="doctor-footer text-white-50">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled small mb-0">
                    ...
                    <li><a href="{{ route('privacy') }}" class="text-white-50 text-decoration-none">Privacy Policy</a></li>
                    <li><a href="{{ route('terms') }}" class="text-white-50 text-decoration-none">Terms & Conditions</a></li>
                </ul>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled small mb-0">
                    <li><a href="{{ route('listdoctor') }}" class="text-white-50 text-decoration-none">List a Doctor</a></li>
    ...
    3rd Floor, Satavisha Bldg, 11 Hospital Link Road, Eastern Park, Santoshpur, Kolkata, India 700075
                ...
                <p class="small mb-1">
                    ...
                    <a href="tel:{{ $contactus->phone }}" class="text-white-50 text-decoration-none">{{ $contactus->phone }}</a>
                </p>

                <p class="small mb-3">
                    <i class="fa fa-envelope me-2"></i>
                    <a href="mailto:{{ $contactus->mail }}" class="text-white-50 text-decoration-none">{{ $contactus->mail }}</a>
                </p>
