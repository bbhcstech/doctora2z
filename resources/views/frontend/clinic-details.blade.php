                ...
                <div class="col-lg-8">
                    <div class="d-flex align-items-center mb-5">
                        <img class="flex-shrink-0 img-fluid border rounded"
                            src="{{ asset('/admin/uploads/clinic-image/clinic.jpg') }}" alt=""
                            style="width: 80px; height: 80px;">
                        <div class="text-start ps-4">
                            <h3 class="mb-3">{{ $clinic->name }}</h3>
                            <span class="text-truncate me-3"><i
                                    class="fa fa-map-marker-alt text-primary me-2"></i>{{ $clinic->address }}</span>
                        ...
                        @if ($clinic->images)
                            ...
                            @if ($images && is_array($images))
                                @foreach ($images as $image)
                                    <img src="{{ asset($image) }}" alt="Clinic Image"
                    ...
                    @foreach ($clinic->doctors as $doctor)
                        <div class="col-md-3">
                            <div class="card mb-4"
                                ...
                                <img src="{{ asset('/admin/uploads/doctor/' . $doctor->image) }}" class="card-img-top"
                                    alt="{{ $doctor->name }}" style="height: 200px; object-fit: cover;">
                                <div class="card-body">
                                    {{-- LIVE Indicator --}}
                                    @php
                                        ...
                                        $isLive =
                                            ...
                                            (in_array(strtolower($currentMonth), array_map('strtolower', $months)) &&
                                                in_array(strtolower($currentDay), array_map('strtolower', $days))) ||
