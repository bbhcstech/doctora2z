                            ...
                            <div class="container" style="margin-top: 17rem;">
                                <div class="row justify-content-start">
                                    <div class="col-10 col-lg-8">
                                        ...
                                        <button  data-filter="cat_doctor" class="btn btn-primary filter-btn py-md-3 px-md-5 me-3 animated slideInLeft">Search A Doctor</button>
                                        <button  data-filter="cat_clinic" class="btn btn-secondary filter-btn py-md-3 px-md-5 animated slideInRight">Find A Clinic</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center align-items-center" id="category-list">
                @foreach ($category as $index => $cat)
                 @if($cat->type == 'doctor')
                <div 
                    class="col-lg-2 col-md-2 col-sm-4 fadeInUp category-item" 
                    data-wow-delay="0.1s" 
                    ...
                    <a class="cat-item rounded d-flex align-items-center text-start" 
                        ...
                        <div>
                            ...
                            <h6 class="mt-1" style="font-weight: bold; font-size: 14px; color: #333;">{{$cat->name}}</h6>
                            <p class="mb-0" style="font-size: 11px; color: #666;">{{ $cat->doctors_count }} Doctors</p>
                        </div>
                    </a>
                </div>
                 @endif
            ...
            <div class="text-center mt-4">
                ...
                <button id="browse-less-btn" class="btn btn-secondary py-3 px-5" style="display: none;">Browse Less </button>
            </div>
        </div>
    </div>
</div>
