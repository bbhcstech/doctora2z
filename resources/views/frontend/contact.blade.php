...
@section('content')
    ...
    <div class="container-xxl py-5 bg-dark page-header mb-5 position-relative">
        ...
        <img class=" position-absolute top-0 start-0 w-100 h-100"
            src="{{ asset('/admin/uploads/contact/' . $contactus->banner_image) }}" alt="Background Image"
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <iframe class="position-relative rounded w-100 h-100" src="{{ $contactus->map_url }}" frameborder="0"
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <form action="{{ route('send.email') }}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="message" class="form-control" placeholder="Leave a message here" id="message" style="height: 150px"
                                            required oninvalid="this.setCustomValidity('Please enter your message')" oninput="this.setCustomValidity('')"></textarea>
