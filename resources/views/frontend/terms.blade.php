...
<div class="container-xxl py-5 bg-dark page-header mb-5 position-relative">
    ...
    <img class="position-absolute top-0 start-0 w-100 h-100" 
         src="{{ asset('/admin/uploads/terms/' . ($terms->banner_image ?? 'default.jpg')) }}" 
    ...
    <div class="container">
        ...
        <div class="card shadow-sm p-4">
            <div class="terms-content" style="text-align: justify; line-height: 1.8;">
                ...
                <a href="https://www.doctora2z.com" target="_blank" rel="noopener noreferrer">https://www.doctora2z.com</a> (the "Platform"), you agree to comply with and be bound by the following 
                Terms and Conditions ("Terms"). If you do not agree with these Terms, please do not use the Platform.</p>

                <h5 class="text-primary mt-4 mb-3">1. Eligibility</h5>
                <ul class="mb-4">
                    <li>You must be at least 18 years old to use this Platform.</li>
                    <li>Doctors registering on Doctor A2Z must hold valid medical qualifications and licenses as required 
                ...
                <ul class="mb-4">
                    <li>Doctors are responsible for the accuracy of the information they provide, including qualifications, 
                ...
                <ul class="mb-4">
                    <li>Basic registration may be free. However, premium listings, promotions, or additional services may 
                involve charges.</li>
                ...
                Doctor A2Z.</li>
                    <li>You may not copy, distribute, or use our intellectual property without prior written consent.</li>
                </ul>
                ...
                <p class="mb-4">You agree to indemnify and hold harmless Doctor A2Z, its owners, employees, and partners from any 
                claims, damages, or expenses arising out of your use of the Platform or violation of these Terms.</p>

                <h5 class="text-primary mt-4 mb-3">9. Termination</h5>
                <p class="mb-4">We may suspend or terminate your account or access to the Platform if you breach these Terms or 
                ...
                <p class="mb-4">We may update or revise these Terms from time to time. Any changes will be posted on this page. 
                ...
                <div class="alert alert-light mt-4 border">
                    <p class="mb-0"><strong>By using our Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.</strong></p>
                </div>
            </div>
        </div>
    </div>
