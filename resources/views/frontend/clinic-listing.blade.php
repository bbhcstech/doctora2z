        ...
        <div class="container" style="max-width: 1000px;">
            <div class="account-message shadow-effect text-center p-3 mb-4" 
                ...
                <p style="font-weight: bold; font-size: 16px; color: #333; margin: 0;">
                    ...
                    <a href="mailto:support@doctora2z.com" style="color: #007bff; text-decoration: none; font-weight: bold;">
                    ...
                    <form action="{{ route('listclinicstore') }}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="container" style="background-color: #d8e0f1; padding: 20px; border-radius: 10px; margin:20px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('phone_number2') is-invalid @enderror" id="phone_number2" name="phone_number2" value="{{ old('phone_number2') }}">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4">
                              ...
                              oninvalid="this.setCustomValidity('Please generate your password')" 
                                               oninput="this.setCustomValidity('')">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    firstFileInput.addEventListener("change", function () {
        ...
        body, main, .container, .container-xxl, .row {
            margin: 0;
            padding: 0;
        }
