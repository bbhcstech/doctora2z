...
@section('content')
                    ...
                    @foreach ($bannerImages as $banner)
                        <div class="owl-carousel-item position-relative">
                            <img class="img-fluid" src="{{ asset('admin/uploads/banners/' . $banner->image) }}"
                                alt="{{ $banner->name }}" style="object-fit: contain; height: 30vh;border-radius: 30px;">
    ...
    <div class="fixed-bg d-flex align-items-center justify-content-center">
        <div class="col-6 col-md-8" style="border-radius:10px;">
            <div class="d-flex align-items-center">
                ...
                <div class="state-box d-flex align-items-center me-3"
                    style="border: 1px solid #000; border-radius: 10px; padding: 10px; background-color: #fff;">
                    <!-- Location Icon -->
                ...
                <!-- Search Form -->
                <form id="search-form" method="GET" action="{{ route('search') }}" class="d-flex flex-grow-1"
                    style="margin-top: 16px; ">
                    <div class="input-group w-100" style="border: 1px solid #000;">
                        <!-- Search Input -->
                        <input type="text" id="search-input" name="query" class="form-control"
                            placeholder="Type or speak to search from Doctora2z..." style="border:none;" />
                        <!-- Voice Search Button -->
                        <span class="input-group-text voice-search" id="voice-search-btn" role="button" tabindex="0"
                            style="background-color: #fff; border:none;">
                            <img src="{{ asset('/img/voice-icon.png') }}" width="20">
                        </span>
                        <!-- Search Button -->
                        <button type="submit" style="border:none; background-color: #fff;">
                            <img src="{{ asset('/img/web.png') }}" width="40"
                                style="border-radius: 10px; background-color: #90dfb3; padding:5px;">
                        </button>
                    </div>
                </form>
            </div>
            ...
            <ul id="suggestions-list" class="list-group mt-2"
                style="display: none; position: absolute; z-index: 9999; width: 45%;"></ul>
        </div>
    </div>
    ...
    <!-- Category Start -->
    <div id="category-section" class="search-results mt-4 animated-section"
        ...
        <div class="container-xxl py-2">
            <div class="container">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <!-- Browse More Link -->
                    <button id="browse-more-btn"
                        style="all: unset; font-size: 14px; font-weight: 500; color: #007bff; cursor: pointer;">
                        Browse More →
                    </button>
                </div>
    ...
    <div id="categoryClinic-section" class="search-results mt-4 animated-section"
        style="display:block; margin-left: 20px; margin-right: 20px;">
        <div class="container-xxl py-2">
            <div class="container">
                <div class="d-flex align-items-center justify-content-start ">
                    ...
                    <h1 class="wow fadeInUp" data-wow-delay="0.1s"
                        style="font-size: 20px; font-weight: 600; color: #333; margin-right: 40px; margin-left: 20px;">
                        CLINIC CATEGORIES
                    </h1>
                    ...
                    <div class="row g-lg-5 g-3">
                            ...
                            <div class="row g-xl-3 g-2 pt-lg-1 pt-2 pb-lg-0">
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="d-flex gap-4 py-2 pt-3 why_point">
                                            <div class="flex-shrink-0">
                                                <img src="https://cdn.apollohospitals.com/apollohospitals-live/wca/01-Counters-Hospitals-1.svg"
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="d-flex gap-4 py-2 pt-3 why_point">
                                            <div class="flex-shrink-0">
                                                <img src="https://cdn.apollohospitals.com/apollohospitals-live/wca/02-Counters-Clinics-2.svg"
                                                    alt="" class="point_icon"
                                                    style="margin-bottom: 10px;  border-radius: 10px; padding: 10px; background-color: #fff;">
                                            </div>
                                            <div class="flex-grow-1 why_ah_points">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card border-0 who-card">
                                <img src="{{ asset('/admin/uploads/about/' . $aboutus[0]->page_image) }}"
                                    class="card-img " alt="...">
    ...
    <!--testimonial section-->
    <div id="testimonial-section" class="search-results mt-4 animated-section"
        style="display:block; margin-left: 20px; margin-right: 20px;">
        <div class="container-xxl py-2">
            <div class="container">
                <div class="d-flex align-items-center justify-content-start mb-5">
    ...
    <!-- Contact Start -->
    <div id="contact" class="search-results mt-4 animated-section"
        style="display:block; margin-left: 20px; margin-right: 20px; margin-bottom: 20px;">
        <div class="container-xxl py-2">
            <div class="container">
                <div class="d-flex align-items-center justify-content-start mb-5">
                    <!-- Heading -->
    ...
    <div class="floating-modal">
        ...
        <div class="modal-body">
            ...
            <a href="{{ route('listclinic') }}" class="btn btn-primary rounded-0  px-lg-5 d-none d-lg-block"
                style="border-radius:10px !important;">List A Clinic<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </div>
    ...
    $(document).ready(function() {
        function fetchCity(lat, lon) {
            ...
            fetch(url)
                ...
                .then(data => {
                    const city = data.address && (data.address.city || data.address.town || data.address
                            .village) ?
                            ...
                            if (data.cat_doc && data.cat_doc.length > 0) {
                                data.cat_doc.forEach((catdoc, index) => {
                                    ...
                                    categoryItem.className =
                                        "col text-center fadeInUp category-item";
...
<style>
    ...
    .owl-carousel-item img {
        ...
        object-fit: cover;
        /* This ensures the image keeps its aspect ratio while covering the area */
    }
    ...
    .other-section .row .col {
        ...
        /* Adjust width and include spacing */
        margin: 0 5px;
    ...
    .other-section .row .col:first-child {
        margin-left: 0;
        /* Remove margin for the first column */
    }
