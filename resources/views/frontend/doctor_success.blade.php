...
<main class="container d-flex align-items-center justify-content-center" style="min-height:70vh;">
  <section class="text-center p-5 shadow-sm bg-white rounded" style="max-width:600px; width:100%;" aria-labelledby="success-heading" role="status">
    ...
    {{-- Go to Login Button --}}
    <div class="mt-4">
      <a href="{{ url('/login') }}?redirect={{ route('doctor.profile.show', $doctorId ?? 0) }}"
         id="loginBtn"
