...
<style>
  ...
  .about-panel h2 { margin-bottom: 0.75rem; font-weight: 700; }
  .about-panel p { text-align: justify; margin-bottom: 1rem; color: #333; line-height: 1.6; }

  .why_point { display: flex; align-items: center; gap: 16px; }
  .point_icon {
    width: 56px;
    height: 56px;
    object-fit: contain;
  ...
  .why_ah_points { display: flex; flex-direction: column; justify-content: center; align-items: flex-start; }
  .counter-holder { font-weight: 600; font-size: 1.5rem; display: inline-block; }

  .who-card .card-img { border-radius: 10px; width: 100%; height: auto; object-fit: cover; }

  /* Ensure left and right columns align nicely on wide screens */
  @media (min-width: 992px) {
    #about-section .row.align-center { display: flex; align-items: flex-start; }
    /* keep image and panel roughly aligned by reducing panel margin at larger widths */
    .about-panel { margin-top: 40px; }
    .who-card { margin-top: 40px; }
  }

  /* Mobile adjustments */
  @media (max-width: 767px) {
    .header-carousel .owl-carousel-item img { height: 220px; }
    .about-panel { padding: 16px; margin-top: 16px; }
    .mt-md-7 { margin-top: 2rem !important; }
    .why_point { gap: 12px; }
    .point_icon { width: 48px; height: 48px; }
    .counter-holder { font-size: 1.25rem; }
    .who-card { margin-top: 0.5rem; }
  }

  /* Optional small animation for entrance (subtle) */
  .animated-section { opacity: 0; transform: translateY(8px); transition: opacity 300ms ease, transform 300ms ease; }
          ...
          <div class="col-md-7">
            <div class="about-panel">
              ...
              <div class="row g-xl-3 g-2 pt-lg-1 pb-lg-0">
                @php
                  $counters = [
                    ['icon' => '01-Counters-Hospitals-1.svg', 'count' => $doctorCount, 'label' => 'Verified Doctors'],
                    ['icon' => '02-Counters-Clinics-2.svg', 'count' => $specializationCount, 'label' => 'Specializations'],
                    ['icon' => '04-Pharmacies-2.svg', 'count' => $hospitalCount, 'label' => 'Hospitals'],
                    ['icon' => '06-Doctors-2.svg', 'count' => $clinicCount, 'label' => 'Clinics'],
                  ];
                @endphp
                  ...
                  <div class="col-6 col-md-6">
                    <div class="py-2 why_point">
                      ...
                      <div class="why_ah_points ps-1">
                        <h4 class="mb-0"><span class="counter-holder" data-count="{{ $counter['count'] }}">0</span>+</h4>
