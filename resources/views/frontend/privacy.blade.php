...
<div class="container-xxl py-5 bg-dark page-header mb-5 position-relative">
    ...
    <img class="position-absolute top-0 start-0 w-100 h-100" 
         src="{{ asset('/admin/uploads/privacy/' . ($privacy->banner_image ?? 'default.jpg')) }}" 
         alt="Privacy Policy" 
    ...
    <div class="container">
        ...
        <div class="card shadow-sm p-4">
            <div class="privacy-content" style="text-align: justify; line-height: 1.8;">
                ...
                <ul class="mb-4">
                    <li><strong>Personal Information:</strong> Name, contact, email, age, gender, professional details (for doctors).</li>
                    <li><strong>Sensitive Data:</strong> Registration number, qualifications, consultation details (if voluntarily provided).</li>
                ...
                <div class="alert alert-light mt-4 border">
                    <p class="mb-0"><strong>By using our Platform, you acknowledge that you have read, understood, and agree to this Privacy Policy.</strong></p>
                </div>
            </div>
        </div>
    </div>
