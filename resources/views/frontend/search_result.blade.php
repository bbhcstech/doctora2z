      ...
      <div class="row g-3 g-md-4">
        @foreach($results as $result)
          @php
            ...
            $countryName = data_get($result, 'country.name') ?? data_get($result, 'country_name') ?? '-';
            ...
            $isDoctor = $type === 'doctor' || $speciality || $degree || str_contains(strtolower($resultName), 'dr.') || str_contains(strtolower($resultName), 'doctor');

            $lastUpdate = data_get($result, 'last_update')
                ...
                <div class="d-block d-md-none">
                  ...
                  <div class="mb-3">
                    @if($cityName && $cityName !== '-' && $stateName && $stateName !== '-')
                      <div class="d-flex align-items-center mb-2">
                        ...
                        <span class="text-dark small">{{ $cityName }}, {{ $stateName }}</span>
                      </div>
                    @endif
                  ...
                  <div class="mb-3">
                    <div class="d-flex align-items-center">
                      ...
                      @if($avg)
                        <div class="d-flex align-items-center">
                          @for($i = 1; $i <= 5; $i++)
                            <i class="fa fa-star {{ $i <= round($avg) ? 'text-warning' : 'text-secondary' }} me-1"></i>
                          @endfor
                          <span class="ms-2 text-dark small">({{ number_format($avg, 1) }}/5)</span>
                        </div>
                      @else
                  ...
                  <div class="d-grid gap-2">
                    ...
                    @if($resultId && $type === 'doctor')
                      <a
                        href="{{ route('doctor.details', $resultId) }}"
                    ...
                    @elseif($resultId && $type === 'clinic')
                      <a
                        href="{{ route('clinic.details', ['id' => $resultId]) }}"
                        class="btn btn-success btn-sm py-2"
                      >
                        <i class="fa fa-info-circle me-2"></i>
                        View Clinic
                    ...
                    <div class="col-md-8 d-flex align-items-center">
                      ...
                      <div class="text-start ps-4 w-100">
                        ...
                        <div class="mt-3">
                          ...
                          @if($avg)
                            @for($i = 1; $i <= 5; $i++)
                              <i class="fa fa-star {{ $i <= round($avg) ? 'text-warning' : 'text-secondary' }}"></i>
                            @endfor
              ...
              <div class="card mb-3 h-100 border shadow-sm">
                <div class="card-body d-flex flex-column p-3 p-md-4">
                  ...
                  <div class="mt-auto pt-2">
                    ...
                    @elseif($resultId)
                      <a href="{{ route('doctor.details', $resultId) }}" class="btn btn-outline-primary btn-sm w-100">
                        <i class="fa fa-eye me-2"></i>
                        View Details
                      </a>
                    @else
              ...
              <div class="text-center my-4 p-3 bg-light rounded border">
                ...
                @if(data_get($ad, 'image'))
                  <a href="{{ data_get($ad, 'url', '#') }}" target="_blank">
                    <img
                      src="{{ asset('admin/uploads/advertisement/' . ltrim(data_get($ad, 'image'), '/')) }}"
                      alt="Advertisement"
