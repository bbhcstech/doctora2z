                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-body pt-3">
                            ...
                            {{-- Form --}}
                            <form action="{{ route('doctor.profile.update', $doctor->id ?? null) }}" method="POST"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            <div
                                                style="width:84px; height:84px; overflow:hidden; border:1px solid #eee; border-radius:6px;">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Max 5MB. Upload will replace existing
                                                    image.</small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <a href="{{ route('doctor.profile.show', $doctor->id ?? null) }}"
