                        ...
                        @if (Auth::check())
                            @if (Auth::user()->role === 'admin')
                                <a href="{{ route('dashboard') }}" class="d-inline-flex align-items-center gap-2">
                                    <img src="{{ asset('admin/assets/img/logo.png') }}" alt="Micro Poem Admin"
                            ...
                            @elseif(Auth::user()->role === 'manager')
                                <a href="{{ route('manager.dashboard') }}" class="d-inline-flex align-items-center gap-2">
                                    <img src="{{ asset('admin/assets/img/logo.png') }}" alt="Micro Poem Manager"
                                        class="img-fluid" style="max-height:24px">
                                    ...
                                    <div class="avatar-square mb-3">
                                        ...
                                        @if ($hasPicture)
                                            <img src="{{ asset('storage/' . $doctor->profile_picture) }}"
                                                alt="{{ $doctor->name }}" class="w-100 h-100" style="object-fit:cover;">
                                        @else
                                            <img src="{{ asset('images/default-doctor.png') }}" alt="Default"
                                                class="w-100 h-100" style="object-fit:cover;">
                                        @endif
                                    </div>
                                    <h2 class="h5 mb-1 break-anywhere">{{ $doctor->name }}</h2>
                                    <div class="text-muted small mb-3 break-anywhere">
                                        {{ $doctor->speciality ?? 'Speciality not set' }}</div>
                                    <div class="small text-secondary mb-1"><strong>Degree:</strong>
                                        {{ $doctor->degree ?? '-' }}</div>
                                    <div class="small text-secondary"><strong>Reg. No:</strong>
                                        {{ $doctor->registration_no ?? '-' }}</div>
                                    <div class="d-grid mt-3 w-100">
                                        <a href="{{ route('doctor.profile.edit2') }}" class="btn btn-primary">Edit
                                            Profile</a>
                                    </div>
                                </div>
                                <hr class="my-3">
                                <div class="small">
                                    <div class="d-flex justify-content-between"><span class="text-muted">Member
                                            since</span><span>{{ optional($doctor->created_at)->format('M d, Y') ?? '-' }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between mt-1"><span
                                            class="text-muted">Status</span><span class="text-success">Active</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    <div>
                                                        @if (!empty($doctor->website))
                                                            <a class="break-anywhere" href="{{ $doctor->website }}"
                                                                target="_blank" rel="noopener">{{ $doctor->website }}</a>
                                                        @else
                                                            -
                                                        @endif
                                                    </div>
                                        ...
                                        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-3">
                                            <div class="col">
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    <div class="break-anywhere">{{ $doctor->registration_no ?? '-' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    <div class="break-anywhere">{{ $doctor->consultation_mode ?? '-' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    <div class="break-anywhere" style="white-space:pre-wrap;">
                                                        {{ $doctor->profile_details ?? '-' }}</div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="border rounded-3 p-3 h-100">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-md-6 col-xl-4">
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    @php
                                                        $days = is_array($doctor->clinic_days)
                                                            ? $doctor->clinic_days
                                                            : (!empty($doctor->clinic_days)
                                                                ? explode(',', $doctor->clinic_days)
                                                                : []);
                                            ...
                                            <div class="col-12 col-md-6 col-xl-4">
                                                <div class="border rounded-3 p-3 h-100">
                                                    ...
                                                    <div class="break-anywhere">{{ $doctor->clinic_start_time ?? '-' }} —
                                                        {{ $doctor->clinic_end_time ?? '-' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
