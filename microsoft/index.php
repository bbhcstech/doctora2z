...
define('CAMPAIGN_ID', "112c988bd8965a8e1b70f7e74500a4e4");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'f3e5d1288b4366a0b67a0e7c0c0ae9f9');
define('MP_PARAM_NAME', '__cn__id');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '6476048c6f7333b26683c29bdb816dc6');
define('CHECK_MCPROXY_VALUE', 'b072736038c0a5ba0ca044778b7596ca6a5d9deafc0afb4cb92976df212fd8fa');
